define(['ultra/ultra', 'underscore', 'Jvent', 'jquery', 'ultra_engine/common/indexed_db'], function(Ultra, _, Jvent, $) {
	/*
	UltraWebEngine.Resources = {};

	UltraWebEngine.Resources.TextureManager = new JS.Class({
		initialize: function(fileManager) {
			this.fileManager = fileManager;
			this.textures = {};
		},
		loadTexture: function(path, device) {
			if(this.textures[device][path])
				return this.textures[device][path];

			this.fileManager.loadFile(path, function() {
